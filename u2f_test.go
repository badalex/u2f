...
func TestIt(t *testing.T) {
	...
	mu2f.Users.PutUser(User{User: "test"})
	u := getUser(&mu2f, t)

	_, err := mu2f.Register(u)
	if err != nil {
		t.Fatal(err)
	}
	u = getUser(&mu2f, t)
...
func getUser(mu2f *U2F, t *testing.T) User {
